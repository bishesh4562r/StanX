...
def train(args, data, string):
    ...
    adj_entity, adj_relation, bc_mask = data[4], data[5], data[6]
    ...
    for train_kf, eval_kf in kf.split(data[7]):
        if (cross_validation == 6):
            ...
            train_data = data[7][train_kf]
            eval_data = data[7][eval_kf]
            ...
            model = KG4SL(args,n_entity, n_relation, adj_entity, adj_relation, bc_mask)
